...
import { Wand2, Video, Music, LayoutGrid, Clapperboard, GalleryHorizontalEnd, ScrollText, Scissors } from 'lucide-react'
...
const CARDS: Card[] = [
  ...
  { id: 'scrollvideo', title: '스크롤영상 만들기', desc: '대본이 흐르는\n카드형 영상', Icon: ScrollText, accent: '#14b8a6' },
  { id: 'frames', title: '프레임 추출기', desc: '영상에서 고화질\nPNG 프레임 추출', Icon: Scissors, accent: '#0ea5e9' },
