...
export type View = 'home' | 'shoppingshorts' | 'youtube' | 'scriptanalyzer' | 'sourcefinder' | 'imagegen' | 'videogen' | 'imageedit' | 'scrollvideo' | 'frames' | 'musicgen' | 'cardnews' | 'blog' | 'wizard' | 'gallerygrid' | 'settings'
